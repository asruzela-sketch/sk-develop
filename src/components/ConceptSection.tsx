...
export const ConceptSection = () => {
  return (
    <section id="concept" className="bg-[hsl(40_30%_96%)] py-24 md:py-32">
      <div className="container-wide">
        {/* Header */}
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <p className="label-small text-accent mb-4">Концепция</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          {/* Retail Zone */}
          <ZoneCard
            title="Торгово-общественный блок"
            area="12 411"
            areaLabel="м²"
            image={retailImage}
            description="Коммерческая инфраструктура, формирующая активную городскую среду и сервисное ядро проекта."
            details={
          ...
          {/* Parking Zone */}
          <ZoneCard
            title="Подземный и надземный паркинг"
            area="405"
            areaLabel="м/м"
            secondaryArea="3 839"
            secondaryLabel="м²"
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-[hsl(40_25%_94%)]">
            <span className="text-sm text-muted-foreground">Общая площадь</span>
            <span className="text-2xl font-medium text-foreground">39 482,5</span>
