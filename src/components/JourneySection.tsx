      ...
      <div className="container-wide">
        <div className="relative bg-background rounded-[2rem] shadow-2xl overflow-hidden border border-border/50">
          <div className="grid lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-8 md:p-12 lg:p-16">
              ...
              <div className="space-y-3">
                {currentStage.items.map((item) => (
                  <div key={item} className="group p-4 md:p-5 rounded-2xl bg-gradient-to-br from-muted/60 to-muted/30 border border-border/40 hover:border-border/60 transition-all duration-500 shadow-sm hover:shadow-md">
                ...
                <div className="group p-4 md:p-5 rounded-2xl bg-gradient-to-br from-muted/60 to-muted/30 border border-border/40 hover:border-border/60 transition-all duration-500 shadow-sm hover:shadow-md">
                  <div className="flex items-center gap-4">
                    <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-foreground flex items-center justify-center shadow-lg">
            ...
            {/* Right: Image — natural proportions */}
